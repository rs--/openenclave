...
//    docker.withRegistry("https://${OETOOLS_REPO}",OETOOLS_REPO_CREDENTIALS_ID) {
//        def image = docker.image('oetools-full-18.04:latest')
//        image.pull()
//        image.inside() {
...
//    docker.withRegistry("https://${OETOOLS_REPO}",OETOOLS_REPO_CREDENTIALS_ID) {
//        def image = docker('oetools-full-18.04:latest')
//        image.pull()
//        image.inside() {
