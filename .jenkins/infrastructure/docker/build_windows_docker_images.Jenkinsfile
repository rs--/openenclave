    ...
    node(AGENTS_LABEL) {
        timeout(TIMEOUT_MINUTES) {
            ...
            stage("Build Windows Server 2019 Docker Image") {
                oe2019 = oe.dockerImage("oetools-ws2019:${DOCKER_TAG}", ".jenkins/infrastructure/docker/dockerfiles/windows/Dockerfile.base")
                puboe2019 = oe.dockerImage("oeciteam/oetools-ws2019:${DOCKER_TAG}", ".jenkins/infrastructure/docker/dockerfiles/windows/Dockerfile.base")
            }
